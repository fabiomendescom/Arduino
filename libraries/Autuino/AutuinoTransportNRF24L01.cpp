...
void AutuinoTransportNRF24L01::addFunctionMapperItem(uint16_t sourcenodeaddress,uint16_t notificationtype,uint8_t functionid, uint8_t maptofunctionid) {
	...
	functionmappers = (functionmapper*)realloc(sizeof(functionmapper)*numberoffunctionmappers);
	functionmappers[i-numberoffunctionmappers].sourcenodeaddress = sourcenodeaddress;
	functionmappers[i-numberoffunctionmappers].sourcenotificationtype = notificationtype;
	functionmappers[i-numberoffunctionmappers].sourcefunctionid = functionid;
	functionmappers[i-numberoffunctionmappers].maptofunctionid = maptofunctionid;
}
